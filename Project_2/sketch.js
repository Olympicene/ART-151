...
function draw() {
  ...
  me(x+1000+mouseX, 0,  'red')
  me(x+800+mouseX, 0, 'orange')
  me(x+600+mouseX, 0, 'yellow')
  me(x+400+mouseX, 0, 'green')
  me(x+200+mouseX, 0, 'blue')
  me(x+mouseX, 0, 'purple')
...
function drawShape(point_cloud, color, xOffset=0, yOffset=0) {
  ...
  for (let [x, y] of point_cloud) {
    vertex((x + xOffset) % width, (y + yOffset) % height);
  }
  endShape(CLOSE);
}
